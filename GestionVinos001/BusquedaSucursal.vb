Public Class BusquedaSucursal
    ...
    Public Sub baja()
        com.CommandText = "delete from sucursal where id=" + id
        Try
            con.Open()
            com.ExecuteNonQuery()
            con.Close()
            MsgBox("Baja de sucursal " & id & " exitosa")
    ...
    Public Sub modificar(ByVal d As String, ByVal n As String, ByVal t As String)
        com.CommandText = "update sucursal set direccion='" & d & "',nombre='" & n & "',telefono=" & t & " where id=" & id
        Try
            con.Open()
            com.ExecuteNonQuery()
